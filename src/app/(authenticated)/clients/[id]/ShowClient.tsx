...
export default function ShowClient({ client }: Props) {
  ...
  return (
    <div>
      <div className="flex flex-col items-start gap-6 self-stretch lg:flex-row">
        ...
        <div className="flex w-full flex-col items-start  gap-7">
          <div className="inline-flex h-full w-full flex-col items-start justify-start gap-7">
            <div className="inline-flex flex-wrap items-start justify-start gap-6 self-stretch md:flex-nowrap">
