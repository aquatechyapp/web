...
export default function InfoCardScrollable({
  ...
  return (
    <div className=" inline-flex h-[422px] shrink grow basis-0 flex-col items-center justify-start gap-4 rounded-lg border border-gray-200 bg-gray-50 p-6 ">
      ...
      <div className=" flex h-80 flex-col items-start justify-start gap-4 self-stretch overflow-auto">
        {children}
      </div>
    </div>
  );
